...
export const colorsBgLight = {
  ...
  info: 'bg-[#0D2F78] border-[#0D2F78] text-white',
}
...
export const colorsOutline = {
  ...
  info: [colorsText.info, 'border-[#0D2F78]'],
}
...
export const getButtonColor = (color, isOutlined, hasHover, isActive = false) => {
  const colors = {
    ring: {
      ...
      info: 'ring-[#0D2F78] dark:ring-[#0B245A]',
    },
    active: {
      white: 'bg-gray-100',
      ...
      info: 'bg-[#0D2F78] dark:bg-[#0B245A] text-white',
    },
    bg: {
      white: 'bg-white text-black',
    ...
    bgHover: {
      ...
      info: 'hover:bg-[#0B245A] hover:border-[#0B245A] dark:hover:bg-[#0D2F78] dark:hover:border-[#0D2F78]',
    },
    borders: {
      white: 'border-white',
      ...
      info: 'border-[#0D2F78] dark:border-[#0B245A]',
    },
    text: {
      ...
      info: 'text-[#0D2F78] dark:text-[#0B245A]',
    },
    outlineHover: {
      contrast:
      ...
      info: 'hover:bg-[#0D2F78] hover:text-white dark:hover:text-white dark:hover:border-[#0D2F78]',
    },
  }
